    ...
    <div class="min-h-[80vh] py-12 px-4 md:px-8 flex items-center justify-center">
      <div class="max-w-2xl w-full bg-gray-900 bg-opacity-70 backdrop-blur-sm rounded-xl border border-gray-800 p-8 md:p-12 shadow-lg">
        ...
        <div class="space-y-6">
          ...
          {/* GitHub */}
          <div class="group flex items-center gap-4 p-4 border border-gray-800 rounded-lg hover:border-white hover:shadow-[0_0_15px_#FFFFFF] transition-all duration-300">
            ...
            <div>
              <h3 class="text-gray-400 font-pixel text-sm">GitHub</h3>
              <a
